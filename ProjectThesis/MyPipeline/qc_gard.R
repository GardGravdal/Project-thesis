...
do_qc <- function(fam_file, ## PATH TO .FAM file
  ...
  pheno_path = "C:/Users/gard_/Documents/MasterThesis/ProjectThesis/MyPipeline/Data/GWAS_wing.txt"
  ...
  exit_code <- # system2() calls the command line
    system2(plink_path,
            paste0("--bfile ", file_root, " ",
                   ...
                   "--keep keep.txt ",
                   "--threads ", ncores, " ",
                   "--out inputGEMMA")) # Name of output file, feel free to change
...
do_qc(qc_filt = qc_filt,
      mem = 8000,
      ncores = 6,
      fam_file = "C:/Users/gard_/Documents/MasterThesis/ProjectThesis/MyPipeline/Data/combined_200k_70k_helgeland_south_corrected_snpfiltered_2024-02-05.fam", # FILL IN PATH TO FAM FILE,
      plink_path = "C:/Users/gard_/Documents/MasterThesis/ProjectThesis/MyPipeline/PLINK/plink_win64_20241013/plink" # FILL IN PATH TO PLINK PROGRAM
        )
