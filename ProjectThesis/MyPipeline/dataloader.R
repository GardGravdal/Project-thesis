...
# If ran manually, beware that two arguments are needed the phenotype ("mass" or "tarsus") and whether
# the 70K should be used or not (boolean argument)
#######################################################################

# CHANGE THIS TO YOUR OWN PATH: (i.e where the data is stored)
store_path <- "C:/Users/gard_/Documents/MasterThesis/ProjectThesis/MyPipeline/Data/Processed/"
setwd("C:/Users/gard_/Documents/MasterThesis/ProjectThesis/MyPipeline/Data")
...
if (!require(SMisc)) {
    install.packages("C:/Users/gard_/OneDrive/Documents/MasterThesis/ProjectThesis/GenomicPrediction/src/data/SMisc.tar.gz", repos = NULL, type = "source")
}
...
if (use_big_dataset == T) {
    print("using qc.raw")
    SNP_data_path <- "C:/Users/gard_/Documents/MasterThesis/ProjectThesis/MyPipeline/Data/qc.raw"
    ...
    d.morph <- read.table("C:/Users/gard_/Documents/MasterThesis/ProjectThesis/MyPipeline/Data/AdultMorphology_20241117.csv", header = T, , sep = ",") # sep="\t")
    ...
    data_path <- "C:/Users/gard_/Documents/MasterThesis/ProjectThesis/MyPipeline/Data/"
    ...
    source("C:/Users/gard_/Documents/MasterThesis/ProjectThesis/MyPipeline/h_dataPrep.r")
